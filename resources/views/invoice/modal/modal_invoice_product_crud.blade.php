    <div class="modal fade" id="product_create" tabindex="-1" role="dialog" aria-labelledby="product_create">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form method = "POST" action = "{{ route('product.create.history') }}" autocomplete="off">
                @csrf
                    <table class="table-edit-delete">
                        <tr>
                            ...
                            <td class = "edm-td-right">
                                ...
                                <input type="hidden" class = "edm-input" id="added_history_id" name="added_history_id" value="{{ Request::segment(3) }}" required/>

                                <input type="hidden" class = "edm-input" id="added_owner_type"  value="HISTORY" name="added_owner_type" required/>

                                <input type="hidden" class = "edm-input" id="added_owner_id"  value="{{$profile->INVOICE_NUMBER}}" name="added_owner_id" required/>
    ...
    <div class="modal fade" id="product_edit" tabindex="-1" role="dialog" aria-labelledby="product_edit">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form method = "POST" action = "{{ route('product.update.history') }}" autocomplete="off">
                @csrf
                    <table class="table-edit-delete">
                        <tr>
                            <td class = "edm-td-left">Product Name</td>
                            <td class = "edm-td-right">
                                <input type="hidden" class = "edm-input" id="edited_history_id" name="edited_history_id" value="{{ Request::segment(3) }}" required/>

                                <input type="hidden" class = "edm-input" id="edited_product_id" name="edited_product_id" required/>

                                <input type="hidden" class = "edm-input" id="edited_owner_type"  value="HISTORY" name="edited_owner_type" required/>

                                <input type="hidden" class = "edm-input" id="edited_owner_id"  value="{{$profile->INVOICE_NUMBER}}" name="edited_owner_id" required/>
